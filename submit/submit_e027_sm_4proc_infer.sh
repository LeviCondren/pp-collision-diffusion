...
#SBATCH --output=/pscratch/sd/l/lcondren/MCsim/full_event_mixed/logs/%j_e027_sm_infer.out
#SBATCH --error=/pscratch/sd/l/lcondren/MCsim/full_event_mixed/logs/%j_e027_sm_infer.err

# E027 holdout inference — 4 SM processes in parallel (one per GPU).
