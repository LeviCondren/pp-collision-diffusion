...
#SBATCH --output=/pub/lcondren/wprime_signal_mpi/logs/%j_e033_locality.out
#SBATCH --error=/pub/lcondren/wprime_signal_mpi/logs/%j_e033_locality.err
...
SCRIPT=/data/homezvol0/lcondren/pp-collision-diffusion/scripts/bsm_grid_train_event_c_locality.py
