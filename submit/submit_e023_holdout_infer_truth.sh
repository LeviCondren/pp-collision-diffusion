...
#SBATCH --job-name=e023_infer_truth
#SBATCH --output=/pscratch/sd/l/lcondren/MCsim/wprime_signal/logs/%j_e023_infer_truth.out
#SBATCH --error=/pscratch/sd/l/lcondren/MCsim/wprime_signal/logs/%j_e023_infer_truth.err

# E023 holdout inference — TRUTH-CONDITIONED event features (--use_true_event).
# Stage-1 is bypassed; truth MET/cone features passed directly to model_part.
# Directly comparable to E020c truth inference (A009c-t).
