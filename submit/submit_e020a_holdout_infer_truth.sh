...
#SBATCH --job-name=e020a_infer_truth
#SBATCH --output=/pscratch/sd/l/lcondren/MCsim/wprime_signal/logs/%j_e020a_infer_truth.out
#SBATCH --error=/pscratch/sd/l/lcondren/MCsim/wprime_signal/logs/%j_e020a_infer_truth.err

# E020a holdout inference — TRUTH-CONDITIONED variant.
...
SCRIPT=/global/u2/l/lcondren/ContinuousParamFit/omnilearn_pp/scripts/infer_bsm_grid_event_a.py
