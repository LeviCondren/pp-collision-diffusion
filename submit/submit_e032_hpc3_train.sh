...
#SBATCH --output=/pub/lcondren/wprime_signal_mpi/logs/%j_e032_bsm_mpi_s1.out
#SBATCH --error=/pub/lcondren/wprime_signal_mpi/logs/%j_e032_bsm_mpi_s1.err

# E032 — W' grid (MPI=on) training, stage-1 architecture (bsm_grid_event_c_stage1_mpi).
# Resumed from HuggingFace checkpoint (epoch 95/200, val_loss=4.97).
...
SCRIPT=/data/homezvol0/lcondren/pp-collision-diffusion/scripts/bsm_grid_train_event_c_stage1.py
