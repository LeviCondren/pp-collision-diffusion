...
#SBATCH --job-name=e023_infer_pred
#SBATCH --output=/pscratch/sd/l/lcondren/MCsim/wprime_signal/logs/%j_e023_infer_pred.out
#SBATCH --error=/pscratch/sd/l/lcondren/MCsim/wprime_signal/logs/%j_e023_infer_pred.err

# E023 holdout inference — GENERATED event features (full two-stage pipeline).
# Stage-1 diffusion generates [log_npart, MET, cone_pT/mass] from partons;
# generated features passed to model_part for particle cloud generation.
# Compare to infer_holdout_truth to assess stage-1 event-feature quality.
# 4 holdout points in parallel: (250,250) (250,300) (300,250) (300,300)
...
STATS_PATH=${CKPT_DIR}/normalisation_stats_event_c_stage1.json
