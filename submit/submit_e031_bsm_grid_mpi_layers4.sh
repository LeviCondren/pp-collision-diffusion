...
#SBATCH --output=/pscratch/sd/l/lcondren/MCsim/wprime_signal_mpi/logs/%j_e031_bsm_mpi_l4.out
#SBATCH --error=/pscratch/sd/l/lcondren/MCsim/wprime_signal_mpi/logs/%j_e031_bsm_mpi_l4.err

# E031 — BSM grid training on MPI-on W' data, layers4 architecture.
# Same arch as E022 (PET_pp_parton_vpar_bsm_event_c_layers4, num_gen_layers=4).
# Data: /pscratch/sd/l/lcondren/MCsim/wprime_signal_mpi/ (144 signal + background, MPI=on).
# Holdout points: (250,250) (250,300) (300,250) (300,300) — same as E022.
# Self-resubmitting until training_state.json marks done=true.

SCRIPT=/global/u2/l/lcondren/ContinuousParamFit/omnilearn_pp/scripts/bsm_grid_train_event_c_layers4.py
