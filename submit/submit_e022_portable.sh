#!/bin/bash
# submit_e022_portable.sh — E022 training submit script for non-NERSC clusters.
#
...
#
# To submit:  sbatch submit/submit_e022_portable.sh
...
#SBATCH --output=logs/%j_e022_bsm_event.out
#SBATCH --error=logs/%j_e022_bsm_event.err
