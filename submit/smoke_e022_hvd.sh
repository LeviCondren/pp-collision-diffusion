#!/bin/bash
# smoke_e022_hvd.sh — Smoke test for E022: 1 epoch, tiny data, 4-GPU Horovod, no self-resubmit.
...
#SBATCH --job-name=smoke_e022_hvd
#SBATCH --output=/data/homezvol0/lcondren/pp-collision-diffusion/logs/%j_smoke_e022_hvd.out
#SBATCH --error=/data/homezvol0/lcondren/pp-collision-diffusion/logs/%j_smoke_e022_hvd.err
...
SCRIPT="${REPO_DIR}/scripts/bsm_grid_train_event_c_layers4.py"
