...
#SBATCH --array=0-3
#SBATCH --job-name=a032_elbo_s7p5
#SBATCH --output=/pscratch/sd/l/lcondren/MCsim/wprime_signal_mpi/logs/%A_%a_a032_elbo_s7p5.out
#SBATCH --error=/pscratch/sd/l/lcondren/MCsim/wprime_signal_mpi/logs/%A_%a_a032_elbo_s7p5.err

# A032 — ELBO posterior inference on E035 s=7.5 generated events.
# Same protocol as A028 (s=1.5) but using guidance_scale=7.5 NPZs from E035.
...
NPZ_DIR=${CKPT_DIR}/bsm_grid_event_c_stage1_cfg/infer_cfg_sweep/s7p5
OUT_DIR=${CKPT_DIR}/bsm_grid_event_c_stage1_cfg/mass_inference_a032_s7p5
