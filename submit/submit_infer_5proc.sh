...
#SBATCH --job-name=infer_5proc
#SBATCH --output=/pscratch/sd/l/lcondren/MCsim/full_event_mixed/checkpoints/proc_label_5proc/infer_20k/logs/%j_infer.out
#SBATCH --error=/pscratch/sd/l/lcondren/MCsim/full_event_mixed/checkpoints/proc_label_5proc/infer_20k/logs/%j_infer.err
...
srun python3 -u ${SCRIPTS}/infer_pp_5proc.py \
    --rank 0 --world_size 1 \
    --data_dir    ${DATA_DIR} \
