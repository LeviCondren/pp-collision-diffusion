...
#SBATCH --job-name=e008_infer_ep019
#SBATCH --output=/pscratch/sd/l/lcondren/MCsim/wprime_signal/logs/%j_e008_infer_ep019.out
#SBATCH --error=/pscratch/sd/l/lcondren/MCsim/wprime_signal/logs/%j_e008_infer_ep019.err

# E008 mid-training holdout inference — epoch ~19 diagnostic.
# 4 held-out mass points, 5k events each, 500 steps.
# Distinct from submit_e008_holdout_infer.sh (the final 10k run post-convergence).
#
# Holdout points:  (250,250)  (250,300)  (300,250)  (300,300)
# Output dir:  {CKPT_DIR}/bsm_grid/infer_holdout_ep019_5k/
