...
#SBATCH --job-name=e032_bsm_mpi_s1
#SBATCH --output=/pscratch/sd/l/lcondren/MCsim/wprime_signal_mpi/logs/%j_e032_bsm_mpi_s1.out
#SBATCH --error=/pscratch/sd/l/lcondren/MCsim/wprime_signal_mpi/logs/%j_e032_bsm_mpi_s1.err

# E032 — BSM grid training on MPI-on W' data, stage-1 architecture.
# Same arch as E023 (PET_pp_parton_vpar_bsm_event_c_stage1, num_jet=8, num_jet_mlp=512).
# Data: /pscratch/sd/l/lcondren/MCsim/wprime_signal_mpi/ (144 signal + background, MPI=on).
# Holdout points: (250,250) (250,300) (300,250) (300,300) — same as E023.
# Self-resubmitting until training_state.json marks done=true.

SCRIPT=/global/u2/l/lcondren/ContinuousParamFit/omnilearn_pp/scripts/bsm_grid_train_event_c_stage1.py
