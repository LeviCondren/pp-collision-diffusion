...
#SBATCH --job-name=e022_infer_truth
#SBATCH --output=/pscratch/sd/l/lcondren/MCsim/wprime_signal/logs/%j_e022_infer_truth.out
#SBATCH --error=/pscratch/sd/l/lcondren/MCsim/wprime_signal/logs/%j_e022_infer_truth.err

# E022 holdout inference — truth-conditioned event features.
# Architecture identical to E020c except num_gen_layers=4.
