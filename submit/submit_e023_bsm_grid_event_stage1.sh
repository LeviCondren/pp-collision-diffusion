...
#SBATCH --output=/pscratch/sd/l/lcondren/MCsim/wprime_signal/logs/%j_e023_bsm_stage1.out
#SBATCH --error=/pscratch/sd/l/lcondren/MCsim/wprime_signal/logs/%j_e023_bsm_stage1.err

# E023 — BSM grid training: 8-dim stage-1 diffusion (log_npart + 7 event features).
# Stage-1 ResNet width expanded to mlp_dim=512; separate inputs for stage-1 and stage-2.
# Stats auto-computed to normalisation_stats_event_c_stage1.json on first run.
