...
#SBATCH --output=/pscratch/sd/l/lcondren/MCsim/full_event_mixed/logs/%j_e027_sm_4proc.out
#SBATCH --error=/pscratch/sd/l/lcondren/MCsim/full_event_mixed/logs/%j_e027_sm_4proc.err

# E027 — SM 4-process training with E022 architecture (event_c, num_gen_layers=4).
# Data: dijet, ttbar, wjets, zjets from full_event_mixed/ (500k events each).
# Train on [0:480k], validate on [480k:490k], holdout [490k:500k].
