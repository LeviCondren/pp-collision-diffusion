...
#SBATCH --array=0-3
#SBATCH --job-name=a028_elbo_cfg
#SBATCH --output=/pscratch/sd/l/lcondren/MCsim/wprime_signal_mpi/logs/%A_%a_a028_elbo_cfg.out
#SBATCH --error=/pscratch/sd/l/lcondren/MCsim/wprime_signal_mpi/logs/%A_%a_a028_elbo_cfg.err

# A028 — ELBO posterior inference on E035 s=1.5 generated events.
# Scores 2000 generated events per holdout mass point against all 144 grid
# hypotheses using 200 Monte Carlo timestep samples. Output compatible with
# plot_a022_mass_posterior.py.
...
NPZ_DIR=${CKPT_DIR}/bsm_grid_event_c_stage1_cfg/infer_cfg_sweep/s1p5
OUT_DIR=${CKPT_DIR}/bsm_grid_event_c_stage1_cfg/mass_inference_a028_s1p5
