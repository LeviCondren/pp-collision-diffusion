...
#SBATCH --job-name=cfg_5proc_d10
#SBATCH --output=/pscratch/sd/l/lcondren/MCsim/full_event_mixed/checkpoints/logs/%j_cfg_5proc_d10.out
#SBATCH --error=/pscratch/sd/l/lcondren/MCsim/full_event_mixed/checkpoints/logs/%j_cfg_5proc_d10.err

# E001 — cfg_5proc_dropout10
# CFG training: process-label dropout p=0.10 during training (hardcoded default
# in ProcLabelPET.__init__; no --cfg_drop_prob CLI arg).
