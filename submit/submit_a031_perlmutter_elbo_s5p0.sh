...
#SBATCH --array=0-3
#SBATCH --job-name=a031_elbo_s5p0
#SBATCH --output=/pscratch/sd/l/lcondren/MCsim/wprime_signal_mpi/logs/%A_%a_a031_elbo_s5p0.out
#SBATCH --error=/pscratch/sd/l/lcondren/MCsim/wprime_signal_mpi/logs/%A_%a_a031_elbo_s5p0.err

# A031 — ELBO posterior inference on E035 s=5.0 generated events.
# Same protocol as A028 (s=1.5) but using guidance_scale=5.0 NPZs from E035.
# Comparison: A028 (s=1.5) vs A031 (s=5.0) vs A032 (s=7.5).
...
NPZ_DIR=${CKPT_DIR}/bsm_grid_event_c_stage1_cfg/infer_cfg_sweep/s5p0
OUT_DIR=${CKPT_DIR}/bsm_grid_event_c_stage1_cfg/mass_inference_a031_s5p0
