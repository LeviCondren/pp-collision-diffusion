...
#SBATCH --job-name=e031_infer_e055
#SBATCH --output=/pub/lcondren/wprime_signal_mpi/logs/%j_e031_infer_e055_mX%x.out
#SBATCH --error=/pub/lcondren/wprime_signal_mpi/logs/%j_e031_infer_e055_mX%x.err

# Mass posterior inference — E031 (layers4) snapshot at epoch 55.
# Usage:
#   sbatch --export=ALL,OBS_MX=250,OBS_MY=250 submit_e031_mass_infer_e055.sh

OBS_MX=${OBS_MX:-250}
OBS_MY=${OBS_MY:-250}

GRID_DIR=/pub/lcondren/wprime_signal_mpi
SNAP_CKPT_DIR=${GRID_DIR}/checkpoints_bsm_grid/bsm_grid_event_c_layers4_mpi_snap_e055
OUT_DIR=${GRID_DIR}/mass_inference_e031_e055
