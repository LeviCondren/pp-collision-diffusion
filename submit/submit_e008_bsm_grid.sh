...
#SBATCH --job-name=e008_bsm_grid
#SBATCH --output=/pscratch/sd/l/lcondren/MCsim/wprime_signal/logs/%j_e008_bsm_grid.out
#SBATCH --error=/pscratch/sd/l/lcondren/MCsim/wprime_signal/logs/%j_e008_bsm_grid.err

# E008 — Phase 2 BSM grid training
# Trains WeightedBSMPET on 140 of 144 W'→XY→4q mass-grid signal files
# (4-point 2×2 holdout at (250,250),(250,300),(300,250),(300,300)) plus
# QCD background. Mass (m_X, m_Y) is the 7th parton feature (slots 2/3);
# no process label. Self-resubmitting until training_state.json marks done=true.

SCRIPT=/global/u2/l/lcondren/ContinuousParamFit/omnilearn_pp/scripts/bsm_grid_train.py
