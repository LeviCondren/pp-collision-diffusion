...
#SBATCH --output=/pub/lcondren/wprime_signal_mpi/logs/%j_e034_cfg.out
#SBATCH --error=/pub/lcondren/wprime_signal_mpi/logs/%j_e034_cfg.err
...
SCRIPT=/data/homezvol0/lcondren/pp-collision-diffusion/scripts/bsm_grid_train_event_c_stage1_cfg.py
