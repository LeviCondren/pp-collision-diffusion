...
#SBATCH --job-name=parton_hvd
#SBATCH --output=/pscratch/sd/l/lcondren/MCsim/full_event_fpcd/checkpoints_pet_pp/logs/%j_parton_hvd.out
#SBATCH --error=/pscratch/sd/l/lcondren/MCsim/full_event_fpcd/checkpoints_pet_pp/logs/%j_parton_hvd.err

SCRIPT=/global/u2/l/lcondren/ContinuousParamFit/omnilearn_pp/scripts/per_parton_cond_train.py
RUN_NAME=parton_v1_hvd
...
# ── Schedule next job before running (self-rescheduling chain) ────────────────
