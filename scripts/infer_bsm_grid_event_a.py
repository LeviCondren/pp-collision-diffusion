#!/usr/bin/env python3
"""Phase 2 BSM grid inference — E020a: event-level MET conditioning.

Copied from infer_bsm_grid.py and extended for E020a:
  - Reads truth event features (MET) from holdout HDF5 data.
  - Normalizes using normalisation_stats_event_a.json.
...
if not os.path.exists(stats_event_path):
    raise FileNotFoundError(
        ...
        f"Run bsm_grid_train_event_a.py first to compute them.")
