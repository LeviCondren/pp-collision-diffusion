"""BSM grid training — E035: asymmetric per-cone CFG dropout on cone mass conditioning.
...
from PET_pp_parton_vpar_bsm_event_c_stage1_cfg_asym import WeightedBSMPET_event_c_cfg_asym
...
def parse_args():
    ...
    p.add_argument('--run_name',           default='bsm_grid_event_c_stage1_cfg_asym')
