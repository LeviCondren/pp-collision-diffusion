...
A035 adaptation (2026-09-15): only the model import changed, from the E034
symmetric-CFG architecture file to PET_pp_parton_vpar_bsm_event_c_stage1_cfg_asym
(E036/E038 asym architecture) — the base class PET_pp_parton_vpar_bsm_event_c_stage1
itself is architecturally identical between the two files, so this is a drop-in
swap. Scores A033's composable-CFG generated events (bsm_grid_event_c_stage1_cfg_asym_e038_snap_e043/infer_composable_gs1p5/)
against all 144 grid mass hypotheses.
...
def _parse():
    ...
    p.add_argument('--run_name',   default='bsm_grid_event_c_stage1_cfg_asym_e038_snap_e043')
