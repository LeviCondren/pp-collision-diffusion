#!/usr/bin/env python3
"""Phase 2 BSM grid inference — E020c: all-7 event features, predicted.
...
Two-pass generation:
  ...
  Pass 2: Run E020c (PET_pp_parton_vpar_bsm_event_c) conditioned on those
...
E020c features: all 7 (MET×3 + cone_X×2 + cone_Y×2) — NUM_EVENT_FEAT = 7
"""
...
def _parse():
    ...
    p.add_argument('--run_name',           default='bsm_grid_event_c')
...
from PET_pp_parton_vpar_bsm_event_c import PET_pp_parton_vpar_bsm_event_c
...
print(f'\n[rank {args.rank}] === PASS 2: E020c ({args.num_steps} steps) ===')
...
print(f'[rank {args.rank}] Loaded E020c: {ckpt_path}')
