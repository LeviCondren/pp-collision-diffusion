"""PET_pp_parton_vpar_bsm_event_a — E020a: event-level MET conditioning.
...
Copied from PET_pp_parton_vpar_bsm.py (Phase 2 canonical) and modified for E020a:
  ...
  - Event features: [log(MET_mag+1)_normed, sin(MET_phi), cos(MET_phi)]
...
_NUM_EVENT_FEAT_DEFAULT = 3  # MET: log(mag+1), sin(phi), cos(phi)


class PET_pp_parton_vpar_bsm_event_a(keras.Model):
    def __init__(self,
                 num_feat,
                 num_jet,
                 max_partons=4,
...
class WeightedBSMPET_event_a(PET_pp_parton_vpar_bsm_event_a):
    """|event_weight|-weighted training loss for E020a."""
